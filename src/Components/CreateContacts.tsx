      ...
      <div className="lg:w-[1190px] w-full">
        ...
        <div className="border border-primary lg:w-[450px] lg:m-auto m-5 p-4 rounded flex flex-col gap-5">
          ...
          <label >First Name:</label>
                    <input type="text"  name="firstName" className="input" value={params.firstName} onChange={handleChange} />
          ...
          /> */}
           <label >Last Name:</label>
                    <input type="text"  name="lastName" className="input" value={params.lastName} onChange={handleChange} />
          ...
          <div className="flex items-center lg:gap-[85px] lg:justify-start md:justify-between gap-12">
            ...
            <div className="w-[100px]">
              ...
              /> */}
              <input type="checkbox" id="status" name="status" value="active" defaultValue={edit ? state.status : params?.status} onChange={handleRadio}/>
                    <label>Active</label>
                    <br></br>
                    <input type="checkbox" id="status" name="status" value="inactive" defaultValue={edit ? state.status : params?.status} onChange={handleRadio}/>
